...
\begin{itemize}
    ...
    \item \textbf{Text Word Count:} Approximately 3,000 words (excluding abstract, references, tables, and figures; 3,376 words including abstract)
    \item \textbf{Structured Abstract Word Count:} 326 words
    \item \textbf{Number of Figures:} 4 + 1 graphical abstract
    \item \textbf{Number of Tables:} 5 (plus 5 supplementary tables)
    \item \textbf{Number of References:} 24
\end{itemize}
